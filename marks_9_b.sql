...
--
-- Table structure for table `marks_9_b`
--

DROP TABLE IF EXISTS `marks_9_b`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_9_b` (
...
--
-- Dumping data for table `marks_9_b`
--

LOCK TABLES `marks_9_b` WRITE;
/*!40000 ALTER TABLE `marks_9_b` DISABLE KEYS */;
INSERT INTO `marks_9_b` VALUES (1,875,'english',18,4,64,4,45,2,4,5,5,4,52,70,'B2',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `marks_9_b` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-04-26 11:20:38
