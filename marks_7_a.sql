...
--
-- Table structure for table `marks_7_a`
--

DROP TABLE IF EXISTS `marks_7_a`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_7_a` (
...
--
-- Dumping data for table `marks_7_a`
--

LOCK TABLES `marks_7_a` WRITE;
/*!40000 ALTER TABLE `marks_7_a` DISABLE KEYS */;
INSERT INTO `marks_7_a` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_7_a` ENABLE KEYS */;
UNLOCK TABLES;
