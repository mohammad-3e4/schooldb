...
--
-- Table structure for table `marks_6_b`
--

DROP TABLE IF EXISTS `marks_6_b`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_6_b` (
...
--
-- Dumping data for table `marks_6_b`
--

LOCK TABLES `marks_6_b` WRITE;
/*!40000 ALTER TABLE `marks_6_b` DISABLE KEYS */;
INSERT INTO `marks_6_b` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_6_b` ENABLE KEYS */;
UNLOCK TABLES;
