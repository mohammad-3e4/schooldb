...
--
-- Table structure for table `marks_8_a`
--

DROP TABLE IF EXISTS `marks_8_a`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_8_a` (
...
--
-- Dumping data for table `marks_8_a`
--

LOCK TABLES `marks_8_a` WRITE;
/*!40000 ALTER TABLE `marks_8_a` DISABLE KEYS */;
INSERT INTO `marks_8_a` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_8_a` ENABLE KEYS */;
UNLOCK TABLES;
