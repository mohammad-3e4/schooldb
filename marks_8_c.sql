...
--
-- Table structure for table `marks_8_c`
--

DROP TABLE IF EXISTS `marks_8_c`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_8_c` (
...
--
-- Dumping data for table `marks_8_c`
--

LOCK TABLES `marks_8_c` WRITE;
/*!40000 ALTER TABLE `marks_8_c` DISABLE KEYS */;
INSERT INTO `marks_8_c` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_8_c` ENABLE KEYS */;
UNLOCK TABLES;
