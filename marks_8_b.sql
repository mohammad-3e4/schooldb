...
--
-- Table structure for table `marks_8_b`
--

DROP TABLE IF EXISTS `marks_8_b`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_8_b` (
...
--
-- Dumping data for table `marks_8_b`
--

LOCK TABLES `marks_8_b` WRITE;
/*!40000 ALTER TABLE `marks_8_b` DISABLE KEYS */;
INSERT INTO `marks_8_b` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_8_b` ENABLE KEYS */;
UNLOCK TABLES;
