...
--
-- Table structure for table `marks_4_a`
--

DROP TABLE IF EXISTS `marks_4_a`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `marks_4_a` (
...
--
-- Dumping data for table `marks_4_a`
--

LOCK TABLES `marks_4_a` WRITE;
/*!40000 ALTER TABLE `marks_4_a` DISABLE KEYS */;
INSERT INTO `marks_4_a` VALUES (1,'','','','','','','','','','','','','','','','','','','','','','','','','','','',''),(2,'','','','','','','','','','','','','','','','','','','','','','','','','','','','');
/*!40000 ALTER TABLE `marks_4_a` ENABLE KEYS */;
UNLOCK TABLES;
